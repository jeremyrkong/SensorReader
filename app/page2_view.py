...
class Page2View(tk.Frame):
    ...
    LABEL_NAME = ["Sensor", "Low Press", "Avg Press", "Max Press", "Status"]
    ...
    def _create_widgets(self):
        ...
        for number in range(len(Page2View.LABEL_NAME)):
            self._label = tk.Label(self, text=Page2View.LABEL_NAME[number] + ":", anchor="e", width=10)
