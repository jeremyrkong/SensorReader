# This script tests the Pressure Reading Manager class
#
# Author: Derek Wong
# Version 1.0
import unittest
...
class TestPressureReadingManager(TestCase):
    ...
    def setUp(self):
        ...
        self.test_pressure_reading_manager = PressureReadingManager()


    def test_valid_add_log_message(self):
        """010A - Valid add log message """
        self.assertIsNone(self.test_pressure_reading_manager.add_log_message(model="ABC Sensor Pres M301A",
                                                              min_reading=20.152,
                                                              avg_reading=21.367,
                                                              max_reading=22.005,
                                                              status="OK"))
    ...
    def test_invalid_add_log_message(self):
        ...
        with self.assertRaises(ValueError):
            self.test_pressure_reading_manager.add_log_message(model=None,
                                                              min_reading=20.152,
                                                              avg_reading=21.367,
                                                              max_reading=22.005,
                                                              status="OK")
            self.test_pressure_reading_manager.add_log_message(model="ABC Sensor Pres M301A",
                                                              min_reading=None,
                                                              avg_reading=21.367,
                                                              max_reading=22.005,
                                                              status="OK")
        ...
        with self.assertRaises(ValueError):
            self.test_pressure_reading_manager.add_log_message(model="",
                                                              min_reading=20.152,
                                                              avg_reading=21.367,
                                                              max_reading=22.005,
                                                              status="OK")
    ...
    def test_valid_delete_log_message(self):
        ...
        self.assertTrue(self.test_pressure_reading_manager.delete_log_message(1))
